...
console.log(movieTheater.reservation([{freeSeats: 10, rowNumber: 2}, {freeSeats: 8, rowNumber: 9}], 2))
console.log(movieTheater.reservation([{freeSeats: 10, rowNumber: 2}, {freeSeats: 3, rowNumber: 9}], 5))
console.log(movieTheater.reservation([{freeSeats: 10, rowNumber: 2}, {freeSeats: 8, rowNumber: 9}], 11))
console.log(movieTheater.reservation([{freeSeats: 10, rowNumber: 2}, {freeSeats: 8, rowNumber: 9}], 2))
console.log(movieTheater.reservation([{freeSeats: 10, rowNumber: 2}, {freeSeats: 8, rowNumber: 9}], 2))
