...
// console.log(companyAdministration.firedEmployee(['gosho', 'pesho'], 1))
// console.log(companyAdministration.firedEmployee(['gosho', 'pesho','nasko'], 2))
// console.log(companyAdministration.firedEmployee('something', 2))
// console.log(companyAdministration.firedEmployee(['gosho', 'pesho','nasko'], 2.5))
// console.log(companyAdministration.firedEmployee(['gosho', 'pesho','nasko'], -1))
// console.log(companyAdministration.firedEmployee(['gosho', 'pesho','nasko'], 0))
