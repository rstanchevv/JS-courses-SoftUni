...
//   console.log(lottery.secondChance(5, [3,4,5]))
//   console.log(lottery.secondChance(5, [3,4,6]))
// //   console.log(lottery.secondChance('string', [3,4,6]))
// //   console.log(lottery.secondChance(5, 'string'))
